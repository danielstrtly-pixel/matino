...
INSERT INTO chains (id, name, logo, color, base_url, supported) VALUES
  ('ica', 'ICA', '🔴', '#e3000b', 'https://www.ica.se', true),
  ('hemkop', 'Hemköp', '🟠', '#ff6600', 'https://www.hemkop.se', true),
  ('coop', 'Coop', '🟢', '#00aa46', 'https://www.coop.se', false),
  ('lidl', 'Lidl', '🔵', '#0050aa', 'https://www.lidl.se', false),
  ('willys', 'Willys', '🔴', '#e4002b', 'https://www.willys.se', false)
...
INSERT INTO stores (id, chain_id, external_id, name, city) VALUES
  ('hemkop-4147', 'hemkop', '4147', 'Hemköp Östermalmstorg', 'Stockholm'),
  ('hemkop-2070', 'hemkop', '2070', 'Hemköp Fridhemsplan', 'Stockholm'),
  ('hemkop-2123', 'hemkop', '2123', 'Hemköp Odenplan', 'Stockholm')
