...
export default function AIMenuPage() {
  ...
  const generateMenu = async () => {
    ...
    try {
      const res = await fetch('/api/ai/menu-ai', {
        method: 'POST',
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-8 flex justify-between items-start">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <h1 className="text-3xl font-bold">AI-genererad meny</h1>
            <Badge variant="secondary" className="bg-purple-100 text-purple-800">
              🧪 Beta
            </Badge>
          </div>
          <p className="text-gray-600">
            Recept skapade av AI baserat på dina preferenser och erbjudanden.
            <br />
            <span className="text-sm text-gray-500">
              Ingen extern receptdatabas — helt svenska recept med metriska mått.
            </span>
          </p>
        </div>
        <Button 
      ...
      <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
        <p className="text-sm text-purple-800">
          <strong>ℹ️ Om AI-genererade recept:</strong> Dessa recept skapas av GPT-4 baserat på 
          dina inställningar. De är inte hämtade från en receptdatabas, vilket betyder att de 
          kan vara unika men inte "testade". Näringsvärden är uppskattningar.
        </p>
      </div>
                ...
                <CardHeader className="pb-2">
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <p className="text-sm font-medium text-purple-600">{item.day}</p>
