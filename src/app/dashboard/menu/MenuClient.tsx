...
interface MenuClientProps {
  initialMenu: GeneratedMenu | null;
  initialSavedRecipeUrls: string[];
}

export default function MenuClient({ initialMenu, initialSavedRecipeUrls }: MenuClientProps) {
  const [menu, setMenu] = useState<GeneratedMenu | null>(initialMenu);
